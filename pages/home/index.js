...
const HomeView = ({children}) => {
    const ecosystemContent = [
        ...
        },
        {
            ...
            link: '/',
            description: 'Независимо дали сте у дома, на път или в офиса, Сиер ПОС Ви помага да менажирате целият си бизнес.',
            bullets: [
                {
                    id: '1',
                    text: 'Менажирайте ресторанта си от всякъде с облачно базираната Сиер ПОС система. Отваряйте нови локации на вашият бизнес с една лесно скалираща система.'
                },
                {
                    id: '2',
